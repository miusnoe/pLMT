...
&= -\frac{8{,}314 ~\text{J/mol K} \cdot \ln \left( \frac{101325 \, \mathrm{Pa}}{20900 \, \mathrm{Pa}} \right)}{\left( \frac{1}{334{,}15 \, \mathrm{K}} - \frac{1}{293{,}15 \, \mathrm{K}} \right)} = 31{,}355 \, \mathrm{kJ\,mol^{-1}}
\end{align*}
Die Verdampfungsenthalpie $\Delta h_v$ wäre dann:
\begin{align*}
\frac{31.355~\text{J/mol}}{118 ~\text{g/mol}}  &= 265,72 ~\text{J/g} \\
			&= 265,720 ~\text{kJ/kg}
\end{align*}
}
\else
