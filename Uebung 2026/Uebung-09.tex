...
Vor Ihnen stehen Gefäße mit jeweils 1 L wässriger Flüssigkeit.
\begin{itemize}
\item In Gefäß A ist eine Stärkelösung suspendiert.
\item In Gefäß B sind 13,125 g Kochsalz gelöst.
...
$E_n$ ist die kryoskopische Konstante, die nur vom Lösungsmittel selbst abhängt (In dem Fall Wasser mit 1,86 K kg/mol). \pp $b$ ist die Molalität. \pp $i$ ist der Van 't Hoff-Faktor, der angibt in wie viele Teilchen der gelöste Stoff durchschnittlich dissoziiert.
}[-5cm]
\end{document}
