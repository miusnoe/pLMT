...
&= 113 ~\text{µm}
\end{align*}
Alle Partikel die größer als 72µm sind, sedimentieren vollständig.
}
\else
\pagebreak
\fi
...
Aus einer wässrigen Suspension sollen Sie mittels einer Dekanterzentrifuge ($D_Z$ = 500 mm, $L_Z$ = 450 mm, $n$ = 1200 min$^{-1}$) den Feststoff zurückgewinnen. Die Zentrifuge wird mit 40 \% Füllung betrieben.  
\marginnote[]{\small Der \fplmt{mittlere Durchmesser $D_m$} beschreibt das arithmetische Mittel aus Außen- und Innendurchmesser.}[5cm]
\begin{itemize}
...
Dekanterzentrifugen arbeiten kontinuierlich und können große Feststoffmengen tolerieren. So können Tellerzentrifugen beispielsweise nur kleinste Mengen Feststoff vertragen. 
