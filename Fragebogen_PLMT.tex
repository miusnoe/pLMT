...
\antwort{ Das Moody-Diagramm zeigt im logarithmischen Maßstab den Zusammenhang zwischen Reibungskoeffizient, Reynoldszahl und Relativer Rauheit. \par
...
\end{itemize}
\includegraphics[width=\columnwidth]{F://LaTeX-Files/pngs/rheo}
\pp
...
In der Düse werden die Polymerketten gestreckt, nach der Düse kehren sie in geknäuelte
ungeordnete Form zurück.
...
\includegraphics[width=\columnwidth]{F://LaTeX-Files/pngs/awtemp}
}
...
\input{F://LaTeX-Files/SoSe2025/PLMT/formelinput.tex}
\end{document}
