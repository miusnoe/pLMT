...
\input{misc/kemie2.tex}
\input{misc/macros.tex}
\input{misc/vlplmtalt.tex}
...
\section{Vorlesung 03 - Keine Tafelanschrift}
...
\pagebreak
\section{Vorlesung 05 - Filmströmung}
...
%\par \vspace*{5mm}
\section{Vorlesung 06 - Rheologie}
\subsection{Wiederholung letzte VL}
...
\node[scale=0.7] at(1.75,3) {\Large \bfseries flüssig};
...
\section{Vorlesung 18 - Keine Tafelanschrift}
KEINE TAFELANSCHRIFT
