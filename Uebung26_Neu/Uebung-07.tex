...
\begin{align*}
\ln(\frac{p_2}{p_1})\cdot \frac{R}{\Delta h_{vM}}+\frac{1}{T_2}&=\frac{1}{T_1} \\
\ln(\frac{101.325~\text{Pa}}{32.500~\text{Pa}}) \cdot \frac{8,314 ~\text{J/(mol K)}}{2,26 \cdot 10^6 ~\text{J/kg} \cdot 0,018 ~\text{kg/mol}}+\frac{1}{373,15}&=2,915 \cdot 10^{-3}~\text{K} \qquad | :\frac{1}{x} \\ 
&=343 ~\text{K}
\end{align*} 
}
\else
