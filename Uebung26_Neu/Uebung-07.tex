...
\ln(p_3) &= \frac{34.791,6 ~\text{J/mol}}{8,314 ~\text{J / (mol K)}} \cdot \left( \frac{1}{298,15 ~\text{K}} - \frac{1}{324,15 ~\text{K}} \right) + \ln(0,126 \cdot 10^5 ~\text{Pa}) \\
&= 10,57 ~\text{Pa}\qquad \qquad| e^x \\ \\
...
\antwort{
\begin{align*}
\ln(p_3) &= \frac{40.657 ~\text{J/mol}}{8,314 ~\text{J / (mol K)}} \cdot \left( \frac{1}{298,15~\text{K}} - \frac{1}{378,15~\text{K}} \right) + \ln(101,325 \cdot 10^3 ~\text{Pa}) \\
&= 14,99~\text{Pa} \qquad \qquad| e^x \\ \\
...
\ln(\frac{101.325~\text{Pa}}{200.000~\text{Pa}}) \cdot \frac{8,314 ~\text{J/(mol K)}}{2,26 \cdot 10^6 ~\text{J/kg} \cdot 0,018 ~\text{kg/mol}}+\frac{1}{373,15 ~\text{K}}&=2,541 \cdot 10^{-3} \cdot ~\text{K}^{-1} \qquad | :\frac{1}{x} \\ 
&=393,55 ~\text{K}
\end{align*} 
...
\begin{align*}
\ln(\frac{p_2}{p_1})\cdot \frac{R}{\Delta h_{vM}}+\frac{1}{T_2}&=\frac{1}{T_1} \\
\ln(\frac{101.325~\text{Pa}}{32.500~\text{Pa}}) \cdot \frac{8,314 ~\text{J/(mol K)}}{2,26 \cdot 10^6 ~\text{J/kg} \cdot 0,018 ~\text{kg/mol}}+\frac{1}{373,15~\text{K}}&=2,915 \cdot 10^{-3}~\text{K} \quad | :\frac{1}{x} \\ 
&=343 ~\text{K}
\end{align*} 
}
\else
...
F_1 &= 8~\text{min} \cdot 10^{\frac{373,15 ~\text{K}-343 ~\text{K}}{20 ~\text{K}}} \\
 &= 257,38 ~\text{min}
\end{align*}
