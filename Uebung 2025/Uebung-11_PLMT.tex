...
\sidebar
\miushead{Übung 11 - Prozessbezogene LMT}{Übung 11}
\par \vspace*{5mm}
...
Verfügung haben?
\textit{Anmerkung: Ein Grad Brix entspricht der Dichte einer Saccharoselösung mit 1 g Saccharose
pro 100 g Lösung}
\pp
...
\pp
\textit{Anmerkung: STP steht für Standard Temperature and Pressure, die Angabe bezieht sich also
auf das Volumen bei Standardbedingungen.}
...
verpackt, in dem jedoch eine Pore (Durchmesser: 12,5 µm) ist. Die Pore ist durch eine
...
Partialdruckunterschied p$_{H2O}$ 14,07 mbar beträgt. Der Permeationskoeffizient für Sauerstoff ist mit 628 (cm$^3$ (STP) $\cdot$ 100 µm)/(m$^2$ $\cdot$ d $\cdot$ bar) gegeben. Der Permeationskoeffizient für Wasserdampf beträgt (16,72 g $\cdot$ 100 µm)/(m$^2$ $\cdot$ d $\cdot$ bar). \par  
\textbf{Fehler:} Anstatt Durchmesser soll es Radius heißen
\pp 
\boxfr{
\pp
\begin{ctab}{1}{ll}
...
\begin{align*}
J &= P \cdot A \cdot \frac{\Delta p}{l} \\
 &= \frac{6,28 \cdot 10^{-6}~\text{m}^3 \cdot 10^{-4} ~\text{m}}{~\text{m}^2 \cdot ~\text{d} \cdot ~\text{bar}} \cdot \pi  \left( 1,25 \cdot 10^{-5}~\text{m} \right)^2  \cdot \frac{0,21 ~\text{bar}}{4 \cdot 10^{-5} ~\text{m}} \\
...
\pp
a) Berechnen Sie, wieviel L Orangennektar aus 1 L Saft hergestellt werden können.
\begin{align*}
\frac{9g}{L} \cdot 1 L &= \frac{5g}{L} \cdot x  \\
x &= \frac{9g}{L} \cdot \frac{L}{5g} \\
x &= \frac{9}{5} = 1,8 L
\end{align*}
...
\pp
b) Berechnen Sie, welche Mengen an Saccharoselösung und Wasser entsprechend zu dem
...
\end{align*}
Um einen Liter Nektar herstellen zu können benötigen wir 0,5644 kg Saft. \par 
