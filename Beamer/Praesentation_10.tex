...
\begin{align*}
\uncover<6->{v &= \frac{d^2 \cdot g \cdot (\rho_1 - \rho_2)}{18 \cdot \eta} \\}
\uncover<7->{v &= \frac{(5 \cdot 10^{-6} ~\text{m})^2 \cdot 9,81 ~\text{m/s}^2 \cdot 99,8 ~\text{kg/m}^3}{18 \cdot 1,79 \cdot 10^{-3} ~\text{Pa s}} \\}
