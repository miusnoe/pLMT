...
\only<2->{\addplot[color=uniblau, thick, mark=*] coordinates {(104,27.5) (107,14.5) (110,7.5) (113, 4) (116,2.2)};}
...
\antwort{
\begin{align*}
\uncover<2->{D_1 &= D_2 \cdot 10^{\frac{T_2-T_1}{z}} \\}
\uncover<3->{D_1 &= 3 \cdot 10^{\frac{121,1-112}{10}} \\
 &= 24,38 ~\text{min}}
\end{align*}
}
\end{minipage}%
